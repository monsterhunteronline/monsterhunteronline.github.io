...
var armor, armorCount, armorID, armorMosaic, armorMosaicNum, armortype, armorType, filterArmor, greaves, greavesCount, greavesID, greavesMosaic, greavesMosaicNum, greavesType, helmCount, helmet, helmetID, helmetMosaic, helmetMosaicNum, helmetType, mosaic10Skills = [], mosaic11Skills = [], mosaic12Skills = [], mosaic13Skills = [], mosaic14Skills = [], mosaic15Skills = [], mosaic1Skills = [], mosaic2Skills = [], mosaic3Skills = [], mosaic4Skills = [], mosaic5Skills = [], mosaic6Skills = [], mosaic7Skills = [], mosaic8Skills = [], mosaic9Skills = [], mosaicSkills10ID, mosaicSkills11ID, mosaicSkills12ID, mosaicSkills13ID, mosaicSkills14ID, mosaicSkills15ID, mosaicSkills1ID, mosaicSkills2ID, mosaicSkills3ID, mosaicSkills4ID, mosaicSkills5ID, mosaicSkills6ID, mosaicSkills7ID, mosaicSkills8ID, mosaicSkills9ID, necklace, necklaceID, negativeSkills = [], passive, positiveSkills = [], ring, ringID, skillsArray = skillsArray.result.rows, skillNames = skillnamesjs(), skills = skillsjs(), talisman, talismanID, talismanSkill1ID, talismanSkill1vID, talismanSkill2ID, talismanSkill2vID, vambraces, vambracesCount, vambracesID, vambracesMosaic, vambracesMosaicNum, vambracesType, waist, waistCount, waistID, waistMosaic, waistMosaicNum, waistType;
...
$(document).on('change', 'select#talismanSkill1Select', function() {updateurl('9', $(this).val()); displayData();});
$(document).on('change', 'select#talismanSkill1vSelect', function() {updateurl('10', $(this).val()); displayData();});
$(document).on('change', 'select#talismanSkill2Select', function() {updateurl('11', $(this).val()); displayData();});
$(document).on('change', 'select#talismanSkill2vSelect', function() {updateurl('12', $(this).val()); displayData();});
$(document).on('change', 'select#talismanSkill3Select', function() {updateurl('13', $(this).val()); displayData();});
$(document).on('change', 'select#talismanSkill3vSelect', function() {updateurl('14', $(this).val()); displayData();});
$(document).on('change', 'select#mosaic1Select1', function() {updateurl('15', $(this).val()); displayData();});
$(document).on('change', 'select#mosaic1Select2', function() {updateurl('16', $(this).val()); displayData();});
$(document).on('change', 'select#mosaic1Select3', function() {updateurl('17', $(this).val()); displayData();});
$(document).on('change', 'select#mosaic2Select1', function() {updateurl('18', $(this).val()); displayData();});
$(document).on('change', 'select#mosaic2Select2', function() {updateurl('19', $(this).val()); displayData();});
$(document).on('change', 'select#mosaic2Select3', function() {updateurl('20', $(this).val()); displayData();});
$(document).on('change', 'select#mosaic3Select1', function() {updateurl('21', $(this).val()); displayData();});
$(document).on('change', 'select#mosaic3Select2', function() {updateurl('22', $(this).val()); displayData();});
$(document).on('change', 'select#mosaic3Select3', function() {updateurl('23', $(this).val()); displayData();});
$(document).on('change', 'select#mosaic4Select1', function() {updateurl('24', $(this).val()); displayData();});
$(document).on('change', 'select#mosaic4Select2', function() {updateurl('25', $(this).val()); displayData();});
$(document).on('change', 'select#mosaic4Select3', function() {updateurl('26', $(this).val()); displayData();});
$(document).on('change', 'select#mosaic5Select1', function() {updateurl('27', $(this).val()); displayData();});
...
// calculate and output mosaic slots
		armorMosaic = "";
		for (i = armor[0].data[5] - 1; i >= 0; i--) {armorMosaic += "o";}
...
// calculate and output mosaic slots
		waistMosaic = "";
		for (i = waist[0].data[5] - 1; i >= 0; i--) {waistMosaic += "o";}
...
// calculate and output mosaic slots
		greavesMosaic = "";
		for (i = greaves[0].data[5] - 1; i >= 0; i--) {greavesMosaic += "o";}
...
// write HTML to IDs if URL Parameters are VALID
	...
	if (typeof talismanSkill1ID !== 'undefined') {document.getElementById("talismanSkills1").innerHTML = skillNames[parseInt(talismanSkill1ID, 10)]+': ';}
	if (typeof talismanSkill1vID !== 'undefined') {document.getElementById("talismanSkills1Value").innerHTML = talismanSkill1vID;}
	if (typeof talismanSkill2ID !== 'undefined') {document.getElementById("talismanSkills2").innerHTML = skillNames[parseInt(talismanSkill2ID, 10)]+': ';}
	if (typeof talismanSkill2vID !== 'undefined') {document.getElementById("talismanSkills2Value").innerHTML = talismanSkill2vID;}
	if (typeof talismanSkill3ID !== 'undefined') {document.getElementById("talismanSkills3").innerHTML = skillNames[parseInt(talismanSkill3ID, 10)]+': ';}
...
// checks armor type of all armors by adding the strings together and checking them for differences. If the set is not complete it will not output as error, rather the border will be black
	...
	if (sumType == "00000") {document.getElementById('typecolor').style.borderColor = '#8aff2b';} 
	if (sumType == "11111") {document.getElementById('typecolor').style.borderColor = '#5cbcfe';}
	if (sumType == "00001" || sumType == "00010" || sumType == "00011" || sumType == "00100" || sumType == "00101" || sumType == "00110" || sumType == "00111" || sumType == "01000" || sumType == "01001" || sumType == "01010" || sumType == "01011" || sumType == "01100" || sumType == "01101" || sumType == "01110" || sumType == "01111" || sumType == "10000" || sumType == "10001" || sumType == "10010" || sumType == "10011" || sumType == "10100" || sumType == "10101" || sumType == "10110" || sumType == "10111" || sumType == "11000" || sumType == "11001" || sumType == "11010" || sumType == "11011" || sumType == "11100" || sumType == "11101" || sumType == "11110") {document.getElementById('typecolor').style.borderColor = '#f44336';}
	if (helmCount > helmetMosaicNum) {document.getElementById('typecolor').style.borderColor = '#f44336';}
	if (vambracesCount > vambracesMosaicNum) {document.getElementById('typecolor').style.borderColor = '#f44336';}
	if (armorCount > armorMosaicNum) {document.getElementById('typecolor').style.borderColor = '#f44336';}
...
function storeArmor() {
	...
	if (typeof waist[0] !== 'undefined') {skills[translate(waist[0].data[38])] = skills[translate(waist[0].data[38])] + parseInt(waist[0].data[39], 10); skills[translate(waist[0].data[40])] = skills[translate(waist[0].data[40])] + parseInt(waist[0].data[41], 10); skills[translate(waist[0].data[42])] = skills[translate(waist[0].data[42])] + parseInt(waist[0].data[43], 10); skills[translate(waist[0].data[44])] = skills[translate(waist[0].data[44])] + parseInt(waist[0].data[45], 10); skills[translate(waist[0].data[46])] = skills[translate(waist[0].data[46])] + parseInt(waist[0].data[47], 10);}
	if (typeof greaves[0] !== 'undefined') {skills[translate(greaves[0].data[38])] = skills[translate(greaves[0].data[38])] + parseInt(greaves[0].data[39], 10); skills[translate(greaves[0].data[40])] = skills[translate(greaves[0].data[40])] + parseInt(greaves[0].data[41], 10); skills[translate(greaves[0].data[42])] = skills[translate(greaves[0].data[42])] + parseInt(greaves[0].data[43], 10); skills[translate(greaves[0].data[44])] = skills[translate(greaves[0].data[44])] + parseInt(greaves[0].data[45], 10); skills[translate(greaves[0].data[46])] = skills[translate(greaves[0].data[46])] + parseInt(greaves[0].data[47], 10);}
	if (typeof talismanSkill1ID !== 'undefined' && talismanSkill1vID !== 'undefined') {skills[translate(skillNames[parseInt(talismanSkill1ID, 10)])] = skills[translate(skillNames[parseInt(talismanSkill1ID, 10)])] + parseInt(talismanSkill1vID, 10);}
	if (typeof talismanSkill2ID !== 'undefined' && talismanSkill2vID !== 'undefined') {skills[translate(skillNames[parseInt(talismanSkill2ID, 10)])] = skills[translate(skillNames[parseInt(talismanSkill2ID, 10)])] + parseInt(talismanSkill2vID, 10);}
	if (typeof talismanSkill3ID !== 'undefined' && talismanSkill3vID !== 'undefined') {skills[translate(skillNames[parseInt(talismanSkill3ID, 10)])] = skills[translate(skillNames[parseInt(talismanSkill3ID, 10)])] + parseInt(talismanSkill3vID, 10);}
	if (typeof mosaic1Skills[5] !== 'undefined') {skills[translate(mosaic1Skills[5])] = skills[translate(mosaic1Skills[5])] + parseInt(mosaic1Skills[6], 10);}
	if (typeof mosaic1Skills[8] !== 'undefined') {skills[translate(mosaic1Skills[8])] = skills[translate(mosaic1Skills[8])] + parseInt(mosaic1Skills[9], 10);}
	if (typeof mosaic2Skills[5] !== 'undefined') {skills[translate(mosaic2Skills[5])] = skills[translate(mosaic2Skills[5])] + parseInt(mosaic2Skills[6], 10);}
	if (typeof mosaic2Skills[8] !== 'undefined') {skills[translate(mosaic2Skills[8])] = skills[translate(mosaic2Skills[8])] + parseInt(mosaic2Skills[9], 10);}
	if (typeof mosaic3Skills[5] !== 'undefined') {skills[translate(mosaic3Skills[5])] = skills[translate(mosaic3Skills[5])] + parseInt(mosaic3Skills[6], 10);}
	if (typeof mosaic3Skills[8] !== 'undefined') {skills[translate(mosaic3Skills[8])] = skills[translate(mosaic3Skills[8])] + parseInt(mosaic3Skills[9], 10);}
	if (typeof mosaic4Skills[5] !== 'undefined') {skills[translate(mosaic4Skills[5])] = skills[translate(mosaic4Skills[5])] + parseInt(mosaic4Skills[6], 10);}
	if (typeof mosaic4Skills[8] !== 'undefined') {skills[translate(mosaic4Skills[8])] = skills[translate(mosaic4Skills[8])] + parseInt(mosaic4Skills[9], 10);}
	if (typeof mosaic5Skills[5] !== 'undefined') {skills[translate(mosaic5Skills[5])] = skills[translate(mosaic5Skills[5])] + parseInt(mosaic5Skills[6], 10);}
	if (typeof mosaic5Skills[8] !== 'undefined') {skills[translate(mosaic5Skills[8])] = skills[translate(mosaic5Skills[8])] + parseInt(mosaic5Skills[9], 10);}
	if (typeof mosaic6Skills[5] !== 'undefined') {skills[translate(mosaic6Skills[5])] = skills[translate(mosaic6Skills[5])] + parseInt(mosaic6Skills[6], 10);}
	if (typeof mosaic6Skills[8] !== 'undefined') {skills[translate(mosaic6Skills[8])] = skills[translate(mosaic6Skills[8])] + parseInt(mosaic6Skills[9], 10);}
	if (typeof mosaic7Skills[5] !== 'undefined') {skills[translate(mosaic7Skills[5])] = skills[translate(mosaic7Skills[5])] + parseInt(mosaic7Skills[6], 10);}
	if (typeof mosaic7Skills[8] !== 'undefined') {skills[translate(mosaic7Skills[8])] = skills[translate(mosaic7Skills[8])] + parseInt(mosaic7Skills[9], 10);}
	if (typeof mosaic8Skills[5] !== 'undefined') {skills[translate(mosaic8Skills[5])] = skills[translate(mosaic8Skills[5])] + parseInt(mosaic8Skills[6], 10);}
	if (typeof mosaic8Skills[8] !== 'undefined') {skills[translate(mosaic8Skills[8])] = skills[translate(mosaic8Skills[8])] + parseInt(mosaic8Skills[9], 10);}
	if (typeof mosaic9Skills[5] !== 'undefined') {skills[translate(mosaic9Skills[5])] = skills[translate(mosaic9Skills[5])] + parseInt(mosaic9Skills[6], 10);}
	if (typeof mosaic9Skills[8] !== 'undefined') {skills[translate(mosaic9Skills[8])] = skills[translate(mosaic9Skills[8])] + parseInt(mosaic9Skills[9], 10);}
	if (typeof mosaic10Skills[5] !== 'undefined') {skills[translate(mosaic10Skills[5])] = skills[translate(mosaic10Skills[5])] + parseInt(mosaic10Skills[6], 10);}
	if (typeof mosaic10Skills[8] !== 'undefined') {skills[translate(mosaic10Skills[8])] = skills[translate(mosaic10Skills[8])] + parseInt(mosaic10Skills[9], 10);}
	if (typeof mosaic11Skills[5] !== 'undefined') {skills[translate(mosaic11Skills[5])] = skills[translate(mosaic11Skills[5])] + parseInt(mosaic11Skills[6], 10);}
	if (typeof mosaic11Skills[8] !== 'undefined') {skills[translate(mosaic11Skills[8])] = skills[translate(mosaic11Skills[8])] + parseInt(mosaic11Skills[9], 10);}
	if (typeof mosaic12Skills[5] !== 'undefined') {skills[translate(mosaic12Skills[5])] = skills[translate(mosaic12Skills[5])] + parseInt(mosaic12Skills[6], 10);}
	if (typeof mosaic12Skills[8] !== 'undefined') {skills[translate(mosaic12Skills[8])] = skills[translate(mosaic12Skills[8])] + parseInt(mosaic12Skills[9], 10);}
	if (typeof mosaic13Skills[5] !== 'undefined') {skills[translate(mosaic13Skills[5])] = skills[translate(mosaic13Skills[5])] + parseInt(mosaic13Skills[6], 10);}
	if (typeof mosaic13Skills[8] !== 'undefined') {skills[translate(mosaic13Skills[8])] = skills[translate(mosaic13Skills[8])] + parseInt(mosaic13Skills[9], 10);}
	if (typeof mosaic14Skills[5] !== 'undefined') {skills[translate(mosaic14Skills[5])] = skills[translate(mosaic14Skills[5])] + parseInt(mosaic14Skills[6], 10);}
	if (typeof mosaic14Skills[8] !== 'undefined') {skills[translate(mosaic14Skills[8])] = skills[translate(mosaic14Skills[8])] + parseInt(mosaic14Skills[9], 10);}
	if (typeof mosaic15Skills[5] !== 'undefined') {skills[translate(mosaic15Skills[5])] = skills[translate(mosaic15Skills[5])] + parseInt(mosaic15Skills[6], 10);}
...
function getPassive(sname, value) {
	...
	for(i = 0; i < skillsArray.length; i ++) {
		if (parseInt(skillsArray[i].data[7], 10) > 0) {positiveSkills.push(skillsArray[i]);}
		if (parseInt(skillsArray[i].data[7], 10) < 0) {negativeSkills.push(skillsArray[i]);}
	}
	if (value > 0) {
		for(i = positiveSkills.length-1; i > 0; i --) {
			if (sname == translate(positiveSkills[i].data[3]) && value >= parseInt(positiveSkills[i].data[7], 10)) {passive = translate(positiveSkills[i].data[5]);}
		}
	}
	if (value < 0) {
		for(i = 0; i < negativeSkills.length; i ++) {
			if (sname == translate(negativeSkills[i].data[3]) && value <= parseInt(negativeSkills[i].data[7], 10)) {passive = translate(negativeSkills[i].data[5]);}
		}
	}
