...
//Large Screen and Small Screen
			...
			//forging mats
			'<td colspan="2">[Forging Material]</td></tr><tr class="no'+arr[i+ii].data[21]+'"><td><a href="/materials/?search='+arr[i+ii].data[21]+'" target="_blank">'+arr[i+ii].data[21]+'</a>x'+arr[i+ii].data[22]+'</td></tr><tr class="no'+arr[i+ii].data[24]+'"><td><a href="/materials/?search='+arr[i+ii].data[24]+'" target="_blank">'+arr[i+ii].data[24]+'</a>x'+arr[i+ii].data[25]+'</td></tr><tr class="no'+arr[i+ii].data[27]+'"><td><a href="/materials/?search='+arr[i+ii].data[27]+'" target="_blank">'+arr[i+ii].data[27]+'</a>x'+arr[i+ii].data[28]+'</td></tr><tr class="no'+arr[i+ii].data[30]+'"><td><a href="/materials/?search='+arr[i+ii].data[30]+'" target="_blank">'+arr[i+ii].data[30]+'</a>x'+arr[i+ii].data[31]+'</td></tr><tr class="no'+arr[i+ii].data[33]+'"><td><a href="/materials/?search='+arr[i+ii].data[33]+'" target="_blank">'+arr[i+ii].data[33]+'</a>x'+arr[i+ii].data[34]+'</td></tr><tr class="no'+arr[i+ii].data[37]+'"><td><a href="/materials/?search='+arr[i+ii].data[36]+'" target="_blank">'+arr[i+ii].data[36]+'</a>x'+arr[i+ii].data[37]+'</td></tr></tbody></table></div>';
		}
//Medium Screens 1
