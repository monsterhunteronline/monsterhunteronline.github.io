var page = "armor", armorArray = armorArray.result, typeArray = [{"type": "(B)"}, {"type": "(G)"}];
function armorjs() {
	helmetMosaicjs(0);
	vambracesMosaicjs(0);
	armorMosaicjs(0);
