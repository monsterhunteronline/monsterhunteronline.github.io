...
//Level
		out += '' +
	'<tr>' +
		'<td><span class="level">Lv.' + levelArray[i].level + '</span></td>' +
...
//attributes
						...
						'<tr>' +
//water	resistance
							'<td colspan="2" class="water' + arr[i+1].data[7] + '">Water Resistance: <span class="white">' + arr[i+1].data[7] + '</span></td>' +
						'</tr>' +
//fire resistance
						'<tr class="fire' + arr[i+1].data[8] + '">' +
							'<td colspan="2">Fire Resistance: <span class="white">' + arr[i+1].data[8] + '</span></td>' +
						'</tr>' +
//thunder resistance
						'<tr class="thunder' + arr[i+1].data[9] + '">' +
							'<td colspan="2">Thunder Resistance: <span class="white">' + arr[i+1].data[9] + '</span></td>' +
						'</tr>' +
//dragon resistance
						'<tr class="dragon' + arr[i+1].data[10] + '">' +
							'<td colspan="2">Dragon Resistance: <span class="white">' + arr[i+1].data[10] + '</span></td>' +
						'</tr>' +
//ice resistance
						'<tr class="ice' + arr[i+1].data[11] + '">' +
...
//attributes
						...
						'<tr>' +
//water	resistance
							'<td colspan="2" class="water' + arr[i+2].data[7] + '">Water Resistance: <span class="white">' + arr[i+2].data[7] + '</span></td>' +
						'</tr>' +
//fire resistance
						'<tr class="fire' + arr[i+2].data[8] + '">' +
							'<td colspan="2">Fire Resistance: <span class="white">' + arr[i+2].data[8] + '</span></td>' +
						'</tr>' +
//thunder resistance
						'<tr class="thunder' + arr[i+2].data[9] + '">' +
							'<td colspan="2">Thunder Resistance: <span class="white">' + arr[i+2].data[9] + '</span></td>' +
						'</tr>' +
//dragon resistance
						'<tr class="dragon' + arr[i+2].data[10] + '">' +
							'<td colspan="2">Dragon Resistance: <span class="white">' + arr[i+2].data[10] + '</span></td>' +
						'</tr>' +
//ice resistance
						'<tr class="ice' + arr[i+2].data[11] + '">' +
...
//attributes
						...
						'<tr>' +
//water	resistance
							'<td colspan="2" class="water' + arr[i+3].data[7] + '">Water Resistance: <span class="white">' + arr[i+3].data[7] + '</span></td>' +
						'</tr>' +
//fire resistance
						'<tr class="fire' + arr[i+3].data[8] + '">' +
							'<td colspan="2">Fire Resistance: <span class="white">' + arr[i+3].data[8] + '</span></td>' +
						'</tr>' +
//thunder resistance
						'<tr class="thunder' + arr[i+3].data[9] + '">' +
							'<td colspan="2">Thunder Resistance: <span class="white">' + arr[i+3].data[9] + '</span></td>' +
						'</tr>' +
//dragon resistance
						'<tr class="dragon' + arr[i+3].data[10] + '">' +
							'<td colspan="2">Dragon Resistance: <span class="white">' + arr[i+3].data[10] + '</span></td>' +
						'</tr>' +
//ice resistance
						'<tr class="ice' + arr[i+3].data[11] + '">' +
...
//attributes
						...
						'<tr>' +
//water	resistance
							'<td colspan="2" class="water' + arr[i+4].data[7] + '">Water Resistance: <span class="white">' + arr[i+4].data[7] + '</span></td>' +
						'</tr>' +
//fire resistance
						'<tr class="fire' + arr[i+4].data[8] + '">' +
							'<td colspan="2">Fire Resistance: <span class="white">' + arr[i+4].data[8] + '</span></td>' +
						'</tr>' +
//thunder resistance
						'<tr class="thunder' + arr[i+4].data[9] + '">' +
							'<td colspan="2">Thunder Resistance: <span class="white">' + arr[i+4].data[9] + '</span></td>' +
						'</tr>' +
//dragon resistance
						'<tr class="dragon' + arr[i+4].data[10] + '">' +
							'<td colspan="2">Dragon Resistance: <span class="white">' + arr[i+4].data[10] + '</span></td>' +
						'</tr>' +
//ice resistance
						'<tr class="ice' + arr[i+4].data[11] + '">' +
