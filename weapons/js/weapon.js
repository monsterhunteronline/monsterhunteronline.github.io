...
function weaponContent(arr) {
 ...
 '<div class="matpiccell weapon">' +
	...
	//can forge icon
				...
				'<img src="../../images/item/' + arr[i].data[4] + '.png">' + '</li>' + 
			'<li class="info">' + 
	...
	//title
					...
					'<tr>' +
	//char level
						'<td colspan="4">Character Level: <span class="white-text">' + arr[i].data[7] + '</span><hr /></td>' +
					'</tr>' +
	//attributes
	...
	//attack
									'<td>Attack:</td>' +
									'<td class="white-text">' + arr[i].data[5] + '</td>' +
								'</tr>' +
								'<tr>' +
	//critical rate
									'<td>Critical Rate:</td>' +
									'<td class="white-text">' + arr[i].data[6] + '</td>' +
								'</tr>' +
	//water attack
								'<tr class="no' + arr[i].data[8] + '">' +
									'<td>Water Attack:</td>' +
									'<td class="white-text">' + arr[i].data[8] + '</td>' +
								'</tr>' +
	//fire attack
								'<tr class="no' + arr[i].data[9] + '">' +
									'<td>Fire Attack:</td>' +
									'<td class="white-text">' + arr[i].data[9] + '</td>' +
								'</tr>' +
	//thunder attack
								'<tr class="no' + arr[i].data[10] + '">' +
									'<td>Thunder Attack:</td>' +
									'<td class="white-text">' + arr[i].data[10] + '</td>' +
								'</tr>' +
	//dragon attack
								'<tr class="no' + arr[i].data[11] + '">' +
									'<td>Dragon Attack:</td>' +
									'<td class="white-text">' + arr[i].data[11] + '</td>' +
								'</tr>' +
	//ice attack
								'<tr class="no' + arr[i].data[12] + '">' +
									'<td>Ice Attack:</td>' +
									'<td class="white-text">' + arr[i].data[12] + '</td>' +
								'</tr>' +
	//poison up
	...
	//shelling properties
								...
								'<tr class="no' + arr[i].data[137] + '">' +
									'<td>Shelling Type:</td>' +
									'<td class="white-text">' + arr[i].data[137] + 
								'</tr>' +
	//shelling rating
								'<tr class="no' + arr[i].data[138] + '">' +
									'<td>Shelling Rating:</td>' +
									'<td class="white-text">' + arr[i].data[138] + '</td>' +
								'</tr>' +
	//bow guage level
								'<tr class="no' + arr[i].data[74] + '">' +
									'<td>Max Guage:</td>' +
									'<td class="white-text">' + arr[i].data[74] + '</td>' +
								'</tr>' +
							'</table>' +
						'</td>' +
					'</tr>' +
	...
	//bow ammo
						...
						'</tr>' +
						'<tr class="no' + arr[i].data[70] + '">' +
							'<td colspan="2" class="white-text">Lv1</td>' +
							'<td colspan="2" class="white-text">' + name[arr[i].data[70]] + '</td>' +
						'</tr>' +
						'<tr class="no' + arr[i].data[70] + '">' +
							'<td colspan="2" class="white-text">Lv2</td>' +
							'<td colspan="2" class="white-text">' + name[arr[i].data[71]] + '</td>' +
						'</tr>' +
						'<tr class="no' + arr[i].data[70] + '">' +
							'<td colspan="2" class="white-text">Lv3</td>' +
							'<td colspan="2" class="white-text">' + name[arr[i].data[72]] + '</td>' +
						'</tr>' +
						'<tr class="no' + arr[i].data[70] + '">' +
	...
	//hunting horn songs
						'<tr class="no' + arr[i].data[143] + '">' +
							'<td colspan="4">' +
								'<table class="innertable">' +
									'<tr class="no' + arr[i].data[143] +'">' +
										'<td><img src="../../images/weapon/' + song1.line1 + '.png"></td>' +
										'<td><img src="../../images/weapon/' + song1.line2 + '.png"></td>' +
										'<td>' + (song1.line3!=""?('<img src="../../images/weapon/' + song1.line3 + '.png">'):"") + '</td>' +
										'<td>' + song1.line5 + '</td>' +
									'</tr>' +
									'<tr class="no' + arr[i].data[144] +'">' +
										'<td><img src="../../images/weapon/' + song2.line1 + '.png"></td>' +
										'<td><img src="../../images/weapon/' + song2.line2 + '.png"></td>' +
										'<td>' + (song2.line3!=""?('<img src="../../images/weapon/' + song2.line3 + '.png">'):"") + '</td>' +
										'<td>' + song2.line5 + '</td>' +
									'</tr>' +
									'<tr class="no' + arr[i].data[145] +'">' +
										'<td><img src="../../images/weapon/' + song3.line1 + '.png"></td>' +
										'<td><img src="../../images/weapon/' + song3.line2 + '.png"></td>' +
										'<td>' + (song3.line3!=""?('<img src="../../images/weapon/' + song3.line3 + '.png">'):"") + '</td>' +
										'<td>' + song3.line5 + '</td>' +
									'</tr>' +
									'<tr class="no' + arr[i].data[146] +'">' +
										'<td><img src="../../images/weapon/' + song4.line1 + '.png"></td>' +
										'<td><img src="../../images/weapon/' + song4.line2 + '.png"></td>' +
										'<td>' + (song4.line3!=""?('<img src="../../images/weapon/' + song4.line3 + '.png">'):"") + '</td>' +
										'<td>' + song4.line5 + '</td>' +
									'</tr>' +
									'<tr class="no' + arr[i].data[147] +'">' +
										'<td><img src="../../images/weapon/' + song5.line1 + '.png"></td>' +
										'<td><img src="../../images/weapon/' + song5.line2 + '.png"></td>' +
										'<td>' + (song5.line3!=""?('<img src="../../images/weapon/' + song5.line3 + '.png">'):"") + '</td>' +
										'<td>' + song5.line5 + '</td>' +
									'</tr>' +
								'</table>' +
						'</tr>' +
	...
	//upgrade mats
			...
			'</div>' +
		'<div>';
	out2 += '<li class="collection-item left-align">' +
				'<table class="weapons left-align">' +
					'<tbody>' +
						'<tr>' +
							'<td>' + out + '</td>' +
							'<td>&nbsp;&nbsp;</td>' +
							'<td>Level: ' + arr[i].data[7] + '<br> Attack: ' + arr[i].data[5] + '</td>' +
							'<td class="right sharpbar no' + arr[i].data[17] + '" colspan="4">' +
								'<div class="basePro clearfix">' +
									'<div class="barWidth">' +
										'<span class="colorBar bar-1" style="width:' + width[0] + '%"></span>' +
										'<span class="colorBar bar-2" style="width:' + width[1] + '%"></span>' +
								...
								'</div>' +
								'<br>&nbsp;&nbsp;' +
								'<span class="blue no' + arr[i].data[8] + '">Water Attack: ' + arr[i].data[8] + '</span>' +
								'<span class="red no' + arr[i].data[9] + '">Fire Attack: ' + arr[i].data[9] + '</span>' +
								'<span class="yellow no' + arr[i].data[10] + '">Thunder Attack: ' + arr[i].data[10] + '</span>' +
								'<span class="purple no' + arr[i].data[11] + '">Dragon Attack: ' + arr[i].data[11] + '</span>' +
								'<span class="light-blue no' + arr[i].data[12] + '">Ice Attack: ' + arr[i].data[12] + '</span>' +
								'<span class="purple lighten-2 no' + arr[i].data[13] + '">Poison+: ' + arr[i].data[13] + '</span>' +
								'<span class="light-blue no' + arr[i].data[14] + '">Sleep+: ' + arr[i].data[14] + '</span>' +
								'<span class="yellow darken-2 no' + arr[i].data[15] + '">Paralysis+: ' + arr[i].data[15] + '</span>' +
							'</td>' +
						'</tr>' +
					'</tbody>' +
				'</table>' +
