<?php
    ...
    echo "<div class='row w3-center'><div class='builder col w3-hide-large m1 w3-hide-small'>&nbsp;</div><div class='builder col l1 m1 s1'><img onclick='updateurl(`" .$ArmorType. "`, " .$ID. "); greavesinfo(); skills();' src='../images/simulator/simu-icon-add.gif' style='width:21px;'></div><div class='builder col l1 m1 s1 type" .$Type. "'>(" .$Type. ")</div><div class='builder col l1 m1 s1'>" .$Level. "</div><div class='builder col l2 m3 s4'>" .$SetName. "</div><div class='builder col l1 m1 s1'><img src='../images/" .$Image. ".png' class='armorimage1' title='" .$SetName. "'></div><div class='builder col l1 m3 s4'>" .$ItemName. "</div><div class='builder col w3-hide-large m1 w3-hide-small'>&nbsp;</div><div class='col w3-hide-large m1 w3-hide-small'>&nbsp;</div><div class='col l1 m2 s12 " .$Skill1. " skill" .$Skill1Num. "'>" .$Skill1. " <span class='plus" .$Skill1Num. "'>+</span>" .$Skill1Num. "</div><div class='col l1 m2 s12 " .$Skill2. " skill" .$Skill2Num. "'>" .$Skill2. " <span class='plus" .$Skill2Num. "'>+</span>" .$Skill2Num. "</div><div class='col l1 m2 s12 " .$Skill3. " skill" .$Skill3Num. "'>" .$Skill3. " <span class='plus" .$Skill3Num. "'>+</span>" .$Skill3Num. "</div><div class='builder col l1 m2 s12 " .$Skill4. " skill" .$Skill4Num. "'>" .$Skill4. " <span class='plus" .$Skill4Num. "'>+</span>" .$Skill4Num. "</div><div class='col l1 m2 s12 " .$Skill5. " skill" .$Skill5Num. "'>" .$Skill5. " <span class='plus" .$Skill5Num. "'>+</span>" .$Skill5Num. "</div><div class='col w3-hide-large m1 w3-hide-small'>&nbsp;</div></div></div>\n";
