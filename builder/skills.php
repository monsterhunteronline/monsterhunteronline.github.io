...
"<tr class='noskill".$sumArray['Reload Spd']."'><td>Reload Spd</td><td>".$helmetArray['Reload Spd']."</td><td>".$vambracesArray['Reload Spd']."</td><td>".$armorArray['Reload Spd']."</td><td>".$waistArray['Reload Spd']."</td><td>".$greavesArray['Reload Spd']."</td><td>".$sumArray['Reload Spd']."</td><td>".$Reload."</td></tr>".
